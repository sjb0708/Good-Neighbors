      ...
      <div style="background:white;border-radius:14px;border:1px solid var(--border);overflow:hidden;margin-bottom:16px;">
        ...
        <div id="frpanel-links" class="fr-tab-panel" style="padding:20px;display:none;">
          ...
          <div style="background:linear-gradient(135deg,#dc2626,#b91c1c);border-radius:14px;padding:22px;text-align:center;color:white;">
            <div style="width:180px;height:180px;background:white;border-radius:50%;margin:0 auto 16px;overflow:hidden;box-shadow:0 8px 28px rgba(0,0,0,0.3);display:flex;align-items:center;justify-content:center;padding:18px;box-sizing:border-box;"><img src="/images/ierf-logo.png" alt="IERF Response" style="width:100%;height:100%;object-fit:contain;display:block;"></div>
